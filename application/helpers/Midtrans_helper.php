...
class Midtrans {
	...
	public static $isProduction = false;
  	...
  	const SANDBOX_BASE_URL = 'https://app.sandbox.midtrans.com/snap/v1/transaction';
  	const PRODUCTION_BASE_URL = 'ttps://app.midtrans.com/snap/v1/transaction';

    public function config($params)
    {
        Midtrans::$serverKey = 'VT-server-YvIiWWkWtfGMgVDlQ-K_9Y01';
