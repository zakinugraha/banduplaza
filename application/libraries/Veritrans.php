...
class Veritrans {
  ...
  public static $isProduction = false;
    ...
    */
    ...
    const SANDBOX_BASE_URL = 'https://app.sandbox.Veritrans.com/snap/v2';
    const PRODUCTION_BASE_URL = 'https://app.sandbox.Veritrans.com/snap/v2';

    public function config($params)
    {
        Veritrans::$serverKey = 'VT-server-Rf92aeHsCNN8vArCIIFk3nbT';
