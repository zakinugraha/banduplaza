      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="<?php echo base_url();?>admin/bank/add" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="bank_name" class="form-control" id="inputEmail3" placeholder="Nama Bank" value="<?php echo set_value('bank_name');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="bank_rek" class="form-control" id="inputEmail3" placeholder="No Rekening" value="<?php echo set_value('bank_rek');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="bank_an" class="form-control" id="inputEmail3" placeholder="Atas Nama" value="<?php echo set_value('bank_an');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="radio">
                      <label>
                        <input type="radio" name="bank_status" id="optionsRadios1" value="enabled" checked>
                        Enabled
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="bank_status" id="optionsRadios2" value="disabled">
                        Disabled
                      </label>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="editor1" name="bank_note"><?php echo set_value('bank_note');?></textarea>
              ...
              <div class="box-footer">
                <input type="submit" name="submit" value="Tambah Bank" class="btn btn-info pull-right">
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
