            ...
            <form method="POST" action="<?php echo current_url();?>" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="brand_name" class="form-control" id="inputEmail3" placeholder="Brand" value="<?php echo isset($_POST['brand_name']) ? $_POST['brand_name'] : $edit->brand_name;?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="brand_api" class="form-control" id="inputEmail3" placeholder="API Name" value="<?php echo isset($_POST['brand_api']) ? $_POST['brand_api'] : $edit->brand_api;?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="editor1" name="brand_description"><?php echo isset($_POST['brand_description']) ? $_POST['brand_description'] : $edit->brand_description;?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="editor1" name="brand_privacy_return"><?php echo isset($_POST['brand_privacy_return']) ? $_POST['brand_privacy_return'] : $edit->brand_privacy_return;?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <div class="radio">
                      <label>
                        <input type="radio" name="brand_status" id="optionsRadios1" value="enabled" <?php echo $edit->brand_status=="enabled"?"checked":"";?> >
                        Enabled
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" name="brand_status" id="optionsRadios2" value="disabled" <?php echo $edit->brand_status=="disabled"?"checked":"";?> >
                        Disabled
                      </label>
                    </div>
                  </div>
