    ...
    <section class="invoice">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <a hfref="<?php echo base_url();?>admin/order/pay/<?php echo $view->invoice_id.'?order_id='.$view->invoice_number.'&inv_shp='.$view->invoice_shipping;?>">
            <button type="button" id="pay-button" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment</button>
          </a>
          <input type="text" name="token" value="<?php echo $snapToken?>">
        </div>
      </div>
    </section>
    <!-- /.content -->
