            ...
            <div class="box-header" style="border-top:1px solid #f4f4f4">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu" style="width:100%">
                  <li><a href="<?php echo base_url();?>admin/product/search?sort_by=newest">Produk Terbaru</a></li>
                  <li><a href="<?php echo base_url();?>admin/product/search?sort_by=best-seller">Produk Terlaris</a></li>
                  <li><a href="<?php echo base_url();?>admin/product/search?sort_by=popular">Paling banyak dilihat</a></li>
                </ul>
              </div>
            </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table" id="tablebody">
                <tr>
                  ...
                  <th style="width: 130px;">Edit Stok</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <br>
                    <span class="text-success"><?php echo $row->type_category_name;?></span> / <span class="text-success"><?php echo $row->type_nav_page_name;?></span> - <span><?php echo full_parsing_date($row->product_create_date);?></span>
