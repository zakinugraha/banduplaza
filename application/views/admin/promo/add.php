      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="<?php echo base_url();?>admin/promo/add" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Label</label>
                  <div class="col-sm-6">
                    <input type="text" name="promo_label" class="form-control" id="inputEmail3" placeholder="Label" value="<?php echo set_value('promo_label');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="promo_value" class="form-control" id="inputEmail3" placeholder="Value" value="<?php echo set_value('promo_value');?>" >
              ...
              <div class="box-footer">
                <input type="submit" name="submit" value="Tambah Promo" class="btn btn-info pull-right">
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
