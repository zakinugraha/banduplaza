            ...
            <form method="POST" action="<?php echo current_url();?>" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="support_title" class="form-control" id="inputEmail3" placeholder="Title" value="<?php echo isset($_POST['support_title'])? $_POST['support_title']:$edit->support_title;?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="editor1" name="support_content"><?php echo isset($_POST['support_content'])? $_POST['support_content']:$edit->support_content;?></textarea>
