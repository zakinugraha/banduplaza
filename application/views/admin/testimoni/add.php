      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="<?php echo base_url();?>admin/testimoni/add" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Name</label>
                  <div class="col-sm-6">
                    <input type="text" name="testimoni_name" class="form-control" id="inputEmail3" placeholder="Name" value="<?php echo set_value('testimoni_name');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="testimoni_region" class="form-control" id="inputEmail3" placeholder="Name" value="<?php echo set_value('testimoni_region');?>" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="editor1" name="testimoni_desc"><?php echo set_value('testimoni_desc');?></textarea>
              ...
              <div class="box-footer">
                <input type="submit" name="submit" value="Tambah Testimoni" class="btn btn-info pull-right">
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
