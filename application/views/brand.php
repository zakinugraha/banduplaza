				...
				<div class="row">
					<div class="col-xs-12">
						<ol class="breadcrumb trans">
							...
							<li><a href="<?php echo base_url();?>">Brand</a></li>
							<li class="slash"><span>/</span></li>
							<li><a><?php echo ucfirst(str_replace('-', ' ', $this->uri->segment(2)));?></a></li>
						</ol>
						                   	...
						                   	<div class="checkboxs">
							                   	<div class="scroll-box">
													<ul class="media-list price">
														...
														<li class="media checkbox">
															<a href="<?php echo base_url().'brand/'.$this->uri->segment(2).'/'.strtolower($g->type_gender_name);?>" class="<?php echo ucfirst($this->uri->segment(3))==$g->type_gender_name ? 'is_active' : '';?>">
					...
					<div class="col-xs-12 col-sm-10 main-listing">
						<div class="content-product">
							<div class="top-box">
								...
								<div class="col-md-6">
									<h3><?php echo str_replace("-", " ", ucfirst($this->uri->segment(2)));?></h3>
								</div>
								<div class="col-md-6">
										...
										<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
											...
											<a class="the-item block same-height" href="<?php echo base_url();?>product/view/<?php echo strtolower($navigasi_name).'/'.url_title(strtolower($row->product_name).'-'.strtolower($row->product_code)).'-'.$row->product_id;?>">
												...
												<div class="images">
													...
													<!-- <img src="<?php echo base_url();?>upload/images/product/thumbs/sepatu1.jpg" alt="Item" /> -->
