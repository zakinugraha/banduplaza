				...
				<div class="row">
					<div class="col-xs-12">
						<ol class="breadcrumb trans">
							...
							<li class="sep"><span><i class="fa fa-caret-right"></i></span></li>
							<li class="active"><?php echo str_replace("-", " ", ucfirst($this->uri->segment(4)));?></li>
						</ol>
					</div> <!-- //col -->
				</div>
			</div>
					...
					<div class="col-xs-12 col-sm-2 sidebar">
						...
						<div id="filter" class="filter collapse">
													...
													<div id="branddivID">
														<ul class="media-list">
															...
															<a href="<?php echo base_url().'product/hot/'.url_title(strtolower($nav_name->type_nav_page_name)).'/discount';?>" class="" >
																<li class="media <?php echo $this->uri->segment(4)=='discount'?'active':'';?>"><span>Diskon</span></li>
															</a>
															<a href="<?php echo base_url().'product/hot/'.url_title(strtolower($nav_name->type_nav_page_name)).'/whatsnew';?>" class="" >
																<li class="media <?php echo $this->uri->segment(4)=='whatsnew'?'active':'';?>"><span>Produk Terbaru</span></li>
															</a>
														</ul>
													</div>
												</div>
							...
							<div class="break checkboxs">
								<div class="b-title"><b>Price</b><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price=n&sort_by='.$filter['sort_by'];?>" class="remove">Hapus Filter</a></div>
								
								<div class="scroll-box">

									<ul class="media-list price">
										<li class="media checkbox">
											<a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price=300000&sort_by='.$filter['sort_by'];?>" class="<?php echo $check=="300000" ? "is_active" : "";?>" >
												<span><i class="fa fa-angle-right"></i> 300.000</span>
											</a>
										</li>
										<li class="media checkbox">
											<a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price=200000,300000&sort_by='.$filter['sort_by'];?>" class="<?php echo $check=="200000,300000" ? "is_active" : "";?>" >
												<span>200.000 - 300.000</span>
											</a>
										</li>
										<li class="media checkbox">
											<a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price=100000,200000&sort_by='.$filter['sort_by'];?>" class="<?php echo $check=="100000,200000" ? "is_active" : "";?>" >
												<span>100.000 - Rp 200.000</span>
											</a>
										</li>
										<li class="media checkbox">
											<a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price=100000&sort_by='.$filter['sort_by'];?>" class="<?php echo $check=="100000" ? "is_active" : "";?>" >
												...
												<div class="select-style">
													<div class="dropdown">
														...
														<ul class="dropdown-menu">
															<li><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price='.$filter['price'].'&sort_by=default';?>">Default</a></li>
															<li><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price='.$filter['price'].'&sort_by=newest';?>">Terbaru</a></li>
															<li><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price='.$filter['price'].'&sort_by=most-popular';?>">Terpopuler</a></li>
															<li><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price='.$filter['price'].'&sort_by=price-high';?>">Harga Tertinggi</a></li>
															<li><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'?price='.$filter['price'].'&sort_by=price-low';?>">Harga Terendah</a></li>
														</ul>
													</div>
												</div>
											</li>
