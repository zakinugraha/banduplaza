			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- <h1>All Shoes Collection</h1>
						<p>Pilih berbagai macam koleksi sepatu yang sesuai dengan gaya kamu. Jadi yang pertama untuk mendapatkan gratis ongkos kirim ke seluruh Indonesia.</p> -->
					</div> <!-- //col -->
				</div>
			</div>
						            ...
						            <div class="panel-heading" role="tab" id="headingThree">
						                <h4 class="panel-title">
						                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-controls="collapseThree" style="display:block;position:relative;">
						                    	<i class="indicator fa fa-angle-up"></i>  Product 
						                    </a>
						                </h4>
						            </div>
								...
								<div class="list-content">
									<div class="row">
										...
										<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
											...
											<!-- <div class="btn-wish">
												<button type="button" id="<?php echo $row->product_id;?>" class="wish"><i class="fa fa-heart"></i></button>
											</div> -->
