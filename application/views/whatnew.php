				...
				<div class="row">
					<div class="col-xs-12">
						<ol class="breadcrumb trans">
							...
							<li><a href="<?php echo base_url();?>whatnew">New Product</a></li>
						</ol>
						            ...
						            <div class="panel-heading" role="tab" id="headingThree">
						                <h4 class="panel-title">
						                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-controls="collapseThree" style="display:block;position:relative;">
						                        Gender <i class="indicator fa fa-angle-up"></i> 
						                    </a>
						                </h4>
						            </div>
						                   	...
						                   	<div class="checkboxs">
							                   	<div class="scroll-box">
													<ul class="media-list price">
														...
														<li class="media checkbox">
															<a href="<?php echo base_url().'whatnew/'.strtolower($g->type_gender_name);?>" class="<?php echo ucfirst($this->uri->segment(2))==$g->type_gender_name ? 'is_active' : '';?>">
																<span><?php echo $g->type_gender_name;?></span>
															</a>
														</li>
														<?php } ?>
													</ul>
													<a href="<?php echo base_url().$this->uri->segment(1);?>" class="remove">Hapus Filter</a>
												</div>
											</div>
						                </div>
						            </div>
						                ...
						                <div class="panel-body">
						                   	<div class="checkboxs">
							                   	<div class="scroll-box">
													...
													<a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'?price=n&sort_by='.$filter['sort_by'];?>" class="remove">Hapus Filter</a>
												</div>
											</div>
						                </div>
						            </div>
