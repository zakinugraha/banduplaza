(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		...
		_addControls		: function() {
			...
			this.$navNext	= $('<span class="es-nav-next"><img src="../assets/front/plugins/responsiveimage/images/next.png"></span>');
			this.$navPrev	= $('<span class="es-nav-prev"><img src="../assets/front/plugins/responsiveimage/images/prev.png"></span>');
			$('<div class="es-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
